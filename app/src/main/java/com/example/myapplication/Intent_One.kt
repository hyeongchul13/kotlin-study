...
class Intent_One : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //      - URL
        //          - 인터넷 페이지의 고유한 주소
        val implicit_intent: TextView = findViewById(R.id.inplicit_intent)
        ...
        // requestCode
        // - 구분을 하기 위해서
        // - Intent-One -> Intent_Two (request 1)
        // - Intent-One -> Intent_Three (request 2)
        // - Intent-One -> Intent_Four (request 3)
        ...
        val startActivityLauncher: ActivityResultLauncher<Intent> =
            registerForActivityResult(ActivityResultContracts.StartActivityForResult()) {
                ...
                // ActivityResult API
                // - 각각의 intent가 처리되는 곳이 별도로 있따. -> 구분이 필요없다
            }
